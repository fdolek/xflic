...
# b=(7075 7075 7077 7080 7080 7083 7086 7088 7090 7095 7098 7103 7105 7105 7105 7120 7122 7127 7127 7127 7127 7130 7130 7130 7130 7130 7130 7130 7130 7130 7130 713D0)
...
# a=(7121 7126 7128 7129 7132 7136)
# b=(7120 7127 7127 7127 7130 7130)
...
k=(5176 5177 5179 5180 5181 5182 5198 5200 5201 5202 5207)
...
#	echo  ${k[$i]}
	echo  ${l[$i]}
# 	./localsubmit.sh 5 ${k[$i]}
#	./localsubmit.sh 104 ${k[$i]}
	./localsubmit.sh 0 ${l[$i]}
	wait
